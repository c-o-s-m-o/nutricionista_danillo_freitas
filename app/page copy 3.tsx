...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans overflow-x-hidden selection:bg-[#CCFF00] selection:text-black">
      ...
      {/* --- NAV BAR --- */}
      <div className="absolute top-0 left-0 w-full z-50 p-4 md:p-6 flex justify-between items-center">
        <div className="text-white font-black italic tracking-tighter text-xl">
          DANILLO<span className="text-[#CCFF00]">FREITAS</span>
        </div>

        <div className="hidden md:flex items-center gap-4 text-xs font-bold text-[#CCFF00] uppercase tracking-widest bg-black/50 px-4 py-2 rounded-full border border-[#CCFF00]/20">
      ...
      <div className="relative z-10 container mx-auto px-4 pt-24 pb-24 flex flex-col items-center">
        ...
        {/* --- DEPOIMENTOS (Grid Clássico - Prova Social) --- */}
            ...
            {[
              {
                ...
                text: "O Protocolo R5 salvou meu vestido de casamento! Me sinto outra mulher.",
              ...
              <div
                key={idx}
                className="bg-[#111] p-6 rounded-2xl border border-white/10 hover:border-[#CCFF00]/30 transition group"
              >
                ...
                <div className="flex items-center gap-3 border-t border-white/5 pt-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#CCFF00] text-[10px] font-black uppercase">
                      {item.desc}
                    </p>
                  </div>
                </div>
        ...
        {/* --- SESSÃO "POR QUE OS DOIS JUNTOS?" --- */}
        <div className="w-full max-w-4xl mx-auto mb-24">
          <div className="bg-gradient-to-r from-[#111] via-[#1a1a1a] to-[#111] border border-[#333] rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            {/* Efeito de Fundo */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#CCFF00]/5 rounded-full blur-[80px]"></div>

            <h2 className="text-2xl md:text-4xl font-black text-white uppercase italic mb-2 relative z-10">
              Por que os dois juntos?
            </h2>
            <p className="text-[#CCFF00] font-bold text-lg md:text-xl mb-8 relative z-10">
              "Porque um ativa. E o outro sustenta."
            </p>

            <div className="flex flex-col md:flex-row justify-center gap-6 text-left max-w-2xl mx-auto mb-8 relative z-10">
              <div className="bg-black/50 p-4 rounded-xl border border-[#CCFF00]/20 flex-1">
                <p className="text-gray-300 text-sm">
                  <strong className="text-white">O R5</strong> destrava e mostra
                  resultado imediato.
                </p>
              </div>
              <div className="bg-black/50 p-4 rounded-xl border border-white/10 flex-1">
                <p className="text-gray-300 text-sm">
                  <strong className="text-white">O EI</strong> mantém, aprofunda
                  e cria constância.
                </p>
              </div>
            </div>

            <div className="inline-block bg-[#CCFF00] text-black font-black text-xs md:text-sm px-6 py-2 rounded-full uppercase tracking-widest relative z-10">
              {">>>"} A Jornada Completa de quem quer emagrecer de verdade
            </div>
          </div>
        </div>
